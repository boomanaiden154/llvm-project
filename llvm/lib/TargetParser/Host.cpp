...
#define setFeature(F) Features[F / 32] |= 1U << (F % 32)
  ...
  if (HasLeaf7 && ((ECX >> 0) & 1))
    setFeature(X86::FEATURE_PREFETCHWT1);
...
// EAX from subleaf 0 is the maximum subleaf supported. Some CPUs don't
  ...
  if (hasFeature(X86::FEATURE_LM) && hasFeature(X86::FEATURE_SSE2)) {
    setFeature(X86::FEATURE_X86_64_BASELINE);
    if (hasFeature(X86::FEATURE_CMPXCHG16B) && hasFeature(X86::FEATURE_POPCNT) &&
        hasFeature(X86::FEATURE_LAHF_LM) && hasFeature(X86::FEATURE_SSE4_2)) {
      ...
      if (hasFeature(X86::FEATURE_AVX2) && hasFeature(X86::FEATURE_BMI) &&
        ...
        if (hasFeature(X86::FEATURE_AVX512BW) && hasFeature(X86::FEATURE_AVX512CD) &&
            hasFeature(X86::FEATURE_AVX512DQ) && hasFeature(X86::FEATURE_AVX512VL))
